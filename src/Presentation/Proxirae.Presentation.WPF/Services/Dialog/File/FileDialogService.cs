...
namespace Proxirae.Presentation.WPF.Services.Dialog.File
{
    public class FileDialogService : IFileDialogService
    {
        ...
        public string? ShowOpenFileDialog(INotifyPropertyChanged ownerViewModel, OpenFileDialogSettings settings)
        {
            var success = _dialogService.ShowOpenFileDialog(ownerViewModel, settings);
            return success == true ? settings.FileName : null;
        }

        public string? ShowSaveFileDialog(INotifyPropertyChanged ownerViewModel, SaveFileDialogSettings settings)
        {
